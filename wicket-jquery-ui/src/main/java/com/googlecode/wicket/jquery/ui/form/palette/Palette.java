...
public class Palette<T> extends org.apache.wicket.extensions.markup.html.form.palette.Palette<T>
{
	...
	public Palette(String id, IModel<? extends List<T>> model, IModel<? extends Collection<T>> choicesModel, IChoiceRenderer<T> choiceRenderer, int rows, boolean allowOrder)
	{
